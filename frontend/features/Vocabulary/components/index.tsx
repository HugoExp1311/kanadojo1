...
const VocabCards = () => {
  ...
  const getCollectionSize = useCallback((level: VocabLevel) => {
    switch (level) {
      case 'n5':
        return N5VocabLength;
      case 'n4':
        return N4VocabLength;
      case 'n3':
        return N3VocabLength;
      case 'n2':
        return N2VocabLength;
      case 'n1':
        return N1VocabLength;
      default:
        return 0;
    }
  }, []);
  ...
  return (
    <LevelSetCards<VocabLevel, IWord>
      ...
      toggleItems={items => addWordObjs(items as unknown as import('@/features/Vocabulary/store/useVocabStore').IVocabObj[])}
