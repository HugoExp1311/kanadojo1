...
const Behavior = () => {
  ...
  const ttsProvider = usePreferencesStore(state => state.ttsProvider) || 'browser';
  const setTtsProvider = usePreferencesStore(state => state.setTtsProvider);
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      {pronunciationEnabled && (
        <>
          <h4 className='text-lg'>Audio Source:</h4>
          <div className='flex flex-row gap-4'>
            <button
              className={clsx(
                buttonBorderStyles,
                'min-w-fit w-1/2 md:w-1/4 p-4',
            ...
            >
              <div className='flex flex-col items-center justify-center w-full'>
                ...
                <span className='text-xs opacity-70'>(Online · Neural)</span>
              </div>
            </button>
          </div>
