...
const KanjiCards = () => {
  ...
  const getCollectionSize = useCallback((level: KanjiLevel) => {
    switch (level) {
      case 'n5':
        return N5KanjiLength;
      case 'n4':
        return N4KanjiLength;
      case 'n3':
        return N3KanjiLength;
      case 'n2':
        return N2KanjiLength;
      case 'n1':
        return N1KanjiLength;
      default:
        return 0;
    }
  }, []);
